...
2. **Line Range Hotspots**
   ...
   - Files: `parity-baseline/baseline_report.json`, `parity-baseline/captures/form-elements.ppm`, `parity-baseline/captures/sticky-scroll.ppm`, `parity-baseline/captures/css-selectors.ppm`
